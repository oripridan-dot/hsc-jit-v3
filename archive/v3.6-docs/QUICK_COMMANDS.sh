#!/bin/bash
# HSC-JIT v3.6 QUICK COMMAND REFERENCE (LEGACY - Use v3.6_commands.sh)
# DEPRECATED: v3.6 uses static build, not dynamic scraping

echo "═══════════════════════════════════════════════════════════"
echo "  HSC-JIT v3.6 - LEGACY COMMANDS (Use v3.6_commands.sh)"
echo "═══════════════════════════════════════════════════════════"
echo ""
...
echo -e "${BLUE}📦 INSTALLATION (Run Once)${NC}"
echo "─────────────────────────────────────────────────────────"
echo ""
echo "1️⃣  Install Playwright & dependencies:"
echo "   pip install playwright httpx"
echo ""
echo "2️⃣  Install Chromium browser:"
echo "   playwright install chromium"
echo ""
echo "3️⃣  Deploy production cron automation:"
...
echo -e "${BLUE}🔧 MANUAL SYNC OPERATIONS${NC}"
echo "─────────────────────────────────────────────────────────"
echo ""
...
echo "   python -c \"from playwright.async_api import async_playwright; print('✅ OK')\""
echo ""
...
echo -e "${BLUE}📋 DATA INSPECTION${NC}"
echo "─────────────────────────────────────────────────────────"
echo ""
