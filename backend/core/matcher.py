"""
Intelligent Matching Module - HSC JIT v3.7.0
==========================================
...
class HalilitMatcher:
    ...
    def match_and_enrich(self, product: Dict, halilit_data: Dict = None) -> Dict:
        ...
        candidates = self.halilit_by_brand.get(
            brand_name, self.halilit_products)
        ...
        if best_match:
            ...
            if confidence >= self.NAME_MATCH_THRESHOLD:
                ...
                enriched = self._enrich_with_match(
                    enriched, match_data, confidence)
                logger.debug(
    ...
    def _find_best_match(
        ...
        for candidate in candidates:
            ...
            score = self._calculate_similarity(
                product_name_clean, candidate_name_clean)
    ...
    def _normalize_name(self, name: str) -> str:
        ...
        normalized = ''.join(c if c.isalnum() or c.isspace()
    ...
    def get_match_statistics(self, products: List[Dict]) -> Dict:
        ...
        excellent = sum(1 for p in products if p.get(
