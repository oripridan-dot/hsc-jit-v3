...
import type { Product, BrandCatalog, MasterIndex } from '../src/types';
...
export const mockProduct: Product = {
    ...
    description: 'Premium electronic drum kit with mesh heads and superior sound engine',
...
export const mockBrandCatalog: BrandCatalog = {
    ...
    description: 'Roland Corporation is a leading manufacturer of music instruments',
...
export const mockProductsByCategory: Record<string, Product[]> = {
    'Electronic Drums': [
        { ...mockProduct, id: 'td-1', name: 'TD-17KVX', category: 'Electronic Drums' },
        { ...mockProduct, id: 'td-2', name: 'TD-27', category: 'Electronic Drums' }
    ],
    'Synthesizers': [
        { ...mockProduct, id: 'synth-1', name: 'Juno-DS', category: 'Synthesizers' },
        { ...mockProduct, id: 'synth-2', name: 'JUPITER-Xm', category: 'Synthesizers' }
    ],
    'Digital Pianos': [
        { ...mockProduct, id: 'piano-1', name: 'FP-90X', category: 'Digital Pianos' }
    ]
};
