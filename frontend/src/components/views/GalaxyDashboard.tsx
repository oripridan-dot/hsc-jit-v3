        ...
        <div className="max-w-2xl text-center space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4 mt-12">
            <div className="bg-[var(--bg-panel)] border border-[var(--border-subtle)] rounded-xl p-4 hover:border-indigo-500/50 transition-all">
              ...
              <div className="text-xs text-[var(--text-tertiary)] uppercase tracking-wide">Products</div>
            </div>
            <div className="bg-[var(--bg-panel)] border border-[var(--border-subtle)] rounded-xl p-4 hover:border-purple-500/50 transition-all">
              ...
              <div className="text-xs text-[var(--text-tertiary)] uppercase tracking-wide">Brands</div>
            </div>
            <div className="bg-[var(--bg-panel)] border border-[var(--border-subtle)] rounded-xl p-4 hover:border-pink-500/50 transition-all">
              ...
              <div className="text-xs text-[var(--text-tertiary)] uppercase tracking-wide">Categories</div>
            </div>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-[var(--border-subtle)]">
            ...
            <ul className="space-y-3 text-left inline-block">
              <li className="flex items-start gap-3 text-[var(--text-secondary)]">
                ...
                <span>Click on a <strong>Brand</strong> in the left sidebar to explore their catalog</span>
              </li>
              <li className="flex items-start gap-3 text-[var(--text-secondary)]">
                <span className="text-purple-400 font-bold">2.</span>
                <span>Select a <strong>Category</strong> to see products in that family</span>
              </li>
              <li className="flex items-start gap-3 text-[var(--text-secondary)]">
                <span className="text-pink-400 font-bold">3.</span>
                <span>Click a <strong>Product</strong> to view detailed specs and media</span>
              </li>
            </ul>
          </div>
          ...
          <div className="mt-12 grid grid-cols-2 gap-4 text-left">
            <div className="bg-gradient-to-br from-indigo-500/10 to-transparent border border-indigo-500/20 rounded-lg p-3">
              <div className="text-sm font-semibold text-indigo-300 mb-1">🎵 Product Details</div>
              <div className="text-xs text-[var(--text-tertiary)]">Full specs, images, videos, and documentation</div>
            </div>
            <div className="bg-gradient-to-br from-purple-500/10 to-transparent border border-purple-500/20 rounded-lg p-3">
              <div className="text-sm font-semibold text-purple-300 mb-1">📊 Structured Data</div>
              <div className="text-xs text-[var(--text-tertiary)]">Clean hierarchies with accurate categorization</div>
            </div>
            <div className="bg-gradient-to-br from-pink-500/10 to-transparent border border-pink-500/20 rounded-lg p-3">
              <div className="text-sm font-semibold text-pink-300 mb-1">🚀 Fast Navigation</div>
              <div className="text-xs text-[var(--text-tertiary)]">Instant switching between views and zoom levels</div>
            </div>
            <div className="bg-gradient-to-br from-amber-500/10 to-transparent border border-amber-500/20 rounded-lg p-3">
              <div className="text-sm font-semibold text-amber-300 mb-1">🎨 Brand Identity</div>
              <div className="text-xs text-[var(--text-tertiary)]">UI colors adapt to your selected brand</div>
            </div>
          </div>
        </div>
      </div>
